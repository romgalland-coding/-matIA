...
# =============================================================================
# 2. DISTRIBUTING GAMES TO USERS (4 status per user)
# =============================================================================
puts "Populating users with games in all 4 statuses..."

# --- Games for PixelKnight (Hardcore / Action focus) ---
Game.create!(
  title: "Elden Ring", platform: "PC, PS5", genre: "Action-RPG",
...
Game.create!(
  title: "Hollow Knight", platform: "PC, PS5, Switch", genre: "Metroidvania",
...
Game.create!(
  title: "Cyberpunk 2077", platform: "PC, PS5", genre: "Sci-Fi RPG",
...
# --- Games for CozyGamer (Chill / Simulation focus) ---
Game.create!(
...
Game.create!(
  title: "Stardew Valley", platform: "PC, Switch, Mobile", genre: "Simulation",
...
Game.create!(
  title: "Slay the Spire", platform: "PC, Switch, Mobile", genre: "Card Battler",
...
# --- Games for CyberPulse (RPG / Narrative focus) ---
Game.create!(
  title: "Baldur's Gate 3", platform: "PC, Xbox Series X", genre: "RPG",
...
Game.create!(
  title: "Red Dead Redemption 2", platform: "PC, Xbox Series X", genre: "Action-Adventure",
...
Game.create!(
  title: "Cyberpunk 2077", platform: "PC, Xbox Series X", genre: "Sci-Fi RPG",
  description: "An open-world, action-adventure story set in the megalopolis of Night City.",
  studio: "CD Projekt Red", sales: 25_000_000, release_date: Date.parse("2020-12-10"),
...
Game.create!(
  title: "Elden Ring", platform: "PC, Xbox Series X", genre: "Action-RPG",
  description: "A challenging open-world action RPG set in a dark fantasy universe.",
  studio: "FromSoftware", sales: 25_000_000, release_date: Date.parse("2022-02-25"),
...
# FINISHED
# =============================================================================
puts "--- Seed successfully executed! Database is perfectly pre-populated for live testing! 🚀 ---"
